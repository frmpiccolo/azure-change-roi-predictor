...
public class RoiService : IRoiService
{
    ...
    public async Task<ProjectInsights?> GetProjectInsightsAsync(ProjectDto projectDto)
    {
        ...
        return JsonSerializer.Deserialize<ProjectInsights>(chatCompletion.Value.Content.First().Text);
    }
}